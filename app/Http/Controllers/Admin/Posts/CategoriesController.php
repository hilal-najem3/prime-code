...
use App\Http\Requests\Posts\Categories\CreateCategoryRequest;
use App\Http\Requests\Posts\Categories\UpdateCategoryRequest;
...
class CategoriesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.posts.categories.create', compact('languages', 'categories'));
    }
    ...
    public function store(CreateCategoryRequest $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('thumbnail')) {
                ...
                $storagePath = "post_categories/{$category->id}/thumbnails";
            ...
            if ($request->hasFile('gallery') !== null) {
                ...
                foreach ($files as $file) {
                    if ($file instanceof \Illuminate\Http\UploadedFile) {
                        $fileName = $file->getClientOriginalName();
                        $storagePath = "post_categories/{$category->id}/media";
                        $file->move(public_path("storage/{$storagePath}"), $fileName);
            ...
            DB::rollBack();
            return redirect()->route('admin.post-categories.index')->with('error', 'Failed to create category.');
        }
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.posts.categories.edit', compact('category', 'languages', 'categories'));
    }
    ...
    public function update(UpdateCategoryRequest $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->route('admin.post-categories.index')->with('error', 'Failed to update category.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            // Delete the entire folder (e.g., post_categories/{categotyId})
            $folderPath = "post_categories/{$category->id}";
            ...
            DB::rollBack();
            return redirect()->route('admin.post-categories.index')->with('error', 'Failed to delete category.');
        }
    }
}
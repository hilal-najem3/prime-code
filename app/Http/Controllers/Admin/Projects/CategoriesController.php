...
use App\Http\Requests\Projects\Categories\CreateCategoryRequest;
use App\Http\Requests\Projects\Categories\UpdateCategoryRequest;
...
class CategoriesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.projects.categories.create', compact('languages', 'categories'));
    }
    ...
    public function store(CreateCategoryRequest $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('thumbnail')) {
                ...
                $storagePath = "project_categories/{$category->id}/thumbnails";
            ...
            if ($request->hasFile('gallery') !== null) {
                ...
                foreach ($files as $file) {
                    if ($file instanceof \Illuminate\Http\UploadedFile) {
                        $fileName = $file->getClientOriginalName();
                        $storagePath = "project_categories/{$category->id}/media";
                        $file->move(public_path("storage/{$storagePath}"), $fileName);
            ...
            DB::rollBack();
            return redirect()->route('admin.project-categories.index')->with('error', 'Failed to create category.');
        }
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.projects.categories.edit', compact('category', 'languages', 'categories'));
    }
    ...
    public function update(UpdateCategoryRequest $request, string $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->route('admin.project-categories.index')->with('error', 'Failed to update category.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            // Remove connection with projects without deleting them
            ...
            // Delete the entire folder (e.g., project_categories/{categotyId})
            $folderPath = "project_categories/{$category->id}";
            ...
            DB::rollBack();
            return redirect()->route('admin.project-categories.index')->with('error', 'Failed to delete category.');
        }
    }
}